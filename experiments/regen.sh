...
LLVM_POWER_FLAGS="--target=powerpc fragments.cpp -I /usr/powerpc-linux-gnu/include/ -I /usr/powerpc-linux-gnu/include/c++/4.9.1/ -I /usr/powerpc-linux-gnu/include/c++/4.9.1/powerpc-linux-gnu"
LLVM_ARM_FLAGS="--target=armv7a fragments.cpp -mfloat-abi=hard -I /usr/arm-linux-gnueabihf/include/ -I /usr/arm-linux-gnueabihf/include/c++/4.9.1/ -I /usr/arm-linux-gnueabihf/include/c++/4.9.1/arm-linux-gnueabihf"

../../build-opt/Release+Asserts/bin/clang $FLAGS fragments.cpp -o fragments-llvm-x86.s
../../build-opt/Release+Asserts/bin/clang $FLAGS $LLVM_POWER_FLAGS -o fragments-llvm-power.s
../../build-opt/Release+Asserts/bin/clang $FLAGS $LLVM_ARM_FLAGS -o fragments-llvm-arm.s
