...
RCU_TESTS+="rculist_user-ec11-rmc-test rculist_user-ec11-c11-test rculist_user-ec11-linux-test "

# RCU tests where the underlying system matches -- eeeeeeeeh
RCU_TESTS+="rculist_user-ermc-rmc-test rculist_user-ec11-c11-test rculist_user-ec11-linux-test"
